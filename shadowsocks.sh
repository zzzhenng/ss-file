...
shadowsockspwd=anywn
shadowsocksport=19999
pick=7
# Current folder
cur_dir=`pwd`
# Stream Ciphers
...
pre_install(){
    ...
    echo "The shadowsocks-python passwd is set to anywn"
    ...
    echo "The shadowsocks-python port is set to 19999"
    ...
    echo "The default cipher is set to aes-256-cfb"
    [ -z "$pick" ] && pick=1
